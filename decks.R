...
decks<-decks%>%#priority 5: Tournament cEDH
  ...
  add_row(deck="Pocket Sized",commander="Francicso & Kediss",power="9",played=2,won=0,draw=1,lost=1,priority="5",W=F,U=F,B=T,R=T,G=F,artist="Rudy Siswanto,Jesper Ejsing",plane='Ixalan,unknown')%>%
  ...
  add_row(deck="Calculator Manipulation",commander="Obeka",power="6",played=7,won=2,draw=1,lost=4,priority="4",W=F,U=T,B=T,R=T,G=F,artist="Jesper Ejsing",plane='Unknown')%>% 
  ...
  add_row(deck="Ethics Violations",commander="Volrath",power="6",played=4,won=2,draw=0,lost=2,priority="4",W=F,U=T,B=T,R=F,G=T,artist="Heonhwa Choe",plane='Dominaria')%>%
  ...
  add_row(deck="Graveyard of Nightmares",commander="Vial Smasher & Thrasios",power="5",played=3,won=0,draw=0,lost=3,priority="4",W=F,U=T,B=T,R=T,G=T,artist="Deruchenko Alexander,Josu Hernaiz",plane='Tarkir,Theros')%>%
  ...
  add_row(deck="Remember the Fallen",commander="Rayami",power="6",played=2,won=0,draw=0,lost=2,priority="4",W=F,U=T,B=T,R=F,G=T,artist="Kieran Yanner",plane='Zendikar') %>%
  ...
  add_row(deck="Clash of the Giants",commander="Mayael",power="5",played=1,won=0,draw=0,lost=1,priority="1",W=T,U=F,B=F,R=T,G=T,artist="Jason Chan",plane='Alara')%>% 
  add_row(deck="Clash in the Sewers",commander="Satoru",power="5",played=0,won=0,draw=0,lost=0,priority="1",W=F,U=T,B=T,R=F,G=F,artist="Yoji Shinkawa",plane='Kamigawa')%>% 
 ...
 #priority 1: unsleeved and unfinished
  add_row(deck="A Shrine to Gallifrey",commander="Fourteenth Doctro & Peri Brown",power="5",played=0,won=0,draw=0,lost=0,priority="1",W=T,U=T,B=F,R=T,G=T,artist="Justyna Dura,Wangjie Li",plane='Tardis,Tardis')%>%   
  add_row(deck="Artificer's Guild",commander="Shattergang",power="5",played=0,won=0,draw=0,lost=0,priority="1",W=F,U=F,B=T,R=T,G=T,artist="Kev Walker",plane='Ravnica,Ravnica,Ravnica')%>%  
  ...
  add_row(deck="Best Boy",commander="Doggo Rex",power="5",played=0,won=0,draw=0,lost=0,priority="1",W=T,U=T,B=F,R=F,G=F,artist="Jeremy Paillotin",plane='Earth')%>%   
  ...
  add_row(deck="Clueing for Looks",commander="Lara Croft",power="6",played=2,won=0,draw=0,lost=0,priority="1",W=F,U=T,B=F,R=T,G=T,artist="Lie Setiawan",plane='Earth')%>% 
  add_row(deck="Consult the Oracle",commander="Sygg",power="6",played=2,won=0,draw=0,lost=0,priority="1",W=F,U=T,B=T,R=F,G=F,artist="Jeremy Enecio",plane='Shadowmoor')%>% 
  ...
  add_row(deck="Feeling Blue",commander="",power="5",played=0,won=0,draw=0,lost=1,priority="1",W=F,U=T,B=F,R=F,G=T,artist="Maaz Ali Khan,Jaroslav Kosmina",plane='Jurassic Park')%>%
  ...
  add_row(deck="Papa-gaios",commander="Don Andres",power="5",played=0,won=0,draw=0,lost=0,priority="1",W=F,U=T,B=T,R=T,G=F,artist="Daarken",plane='Ixalan')%>%
  ...
  add_row(deck="Venture Across Planes",commander="Firja",power="5",played=0,won=0,draw=0,lost=0,priority="1",W=T,U=F,B=T,R=F,G=F,artist="GodMachine",plane='Kaldheim')%>%
  ...
  add_row(deck="Yorkshire Pudding",commander="The Thirteenth Doctor & K-9 Mart I ",power="5",played=0,won=0,draw=0,lost=0,priority="1",W=F,U=T,B=F,R=F,G=T,artist="Lenka Šimečková,Tyler Walpole",plane='Tardis,Tardis')
# colour distibution
