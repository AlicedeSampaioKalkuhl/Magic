...
decks<-decks%>%#priority 8: Tournament cEDH
  ...
  add_row(deck="Depths of Darkness",commander="Thrasios & Reyhan",power="7",played=8,priority="7",W=F,U=T,B=T,R=F,G=T,artist="Josu Hernaiz,Chris Rallis") %>%
  ...
  add_row(deck="Hellrider's Pride",commander="Zevlor",power="5",played=3,priority="6",W=F,U=T,B=T,R=T,G=F,artist="David Rapoza")%>%
  add_row(deck="Keep People Humble",commander="Ivy",power="5",played=4,priority="6",W=F,U=T,B=F,R=F,G=T,artist="Evyn Fong") %>% 
  add_row(deck="Let Me Borrow This",commander="Yasova",power="5",played=4,priority="6",W=F,U=T,B=T,R=T,G=F,artist="Winona Nelson")%>%
  ...
  add_row(deck="Clueing for Looks",commander="Amareth",power="5",played=4,priority="6",W=T,U=T,B=F,R=F,G=T,artist="Lie Setiawan")%>% 
  ...
  add_row(deck="Tea Time",commander="Dina",power="8",played=7,priority="2",W=F,U=F,B=T,R=F,G=T,artist="Chris Rahn")%>%
  ...
  add_row(deck="By the Stroke of Midnight",commander="Rusko",power="5",played=0,priority="1",W=F,U=T,B=T,R=F,G=F,artist="Samuel Perin")%>%
  ...
  add_row(deck="Circus of Souls",commander="Exava",power="5",played=0,priority="1",W=F,U=F,B=T,R=T,G=F,artist="Aleksi Briclot")%>% 
  ...
  add_row(deck="Cursed Gold",commander="Lynde",power="4",played=0,priority="1",W=F,U=T,B=F,R=T,G=F,artist="Anna Steinbauer")%>%    add_row(deck="Danse Macabre",commander="Venser",power="5",played=0,priority="1",W=F,U=T,B=F,R=T,G=F,artist="Dominik Mayer")%>%
  ...
  add_row(deck="Dross Pit Vampires",commander="Kinzu",power="5",played=0,priority="1",W=F,U=F,B=T,R=F,G=F,artist="Andreas Zafiratos")%>% 
  ...
  add_row(deck="Ellylon",commander="Rhys",power="5",played=0,priority="1",W=T,U=F,B=F,R=F,G=T,artist="Steve Prescott")%>% 
  ...
  add_row(deck="Friends of the Forest",commander="Ezuri",power="5",played=0,priority="1",W=F,U=T,B=F,R=F,G=T,artist="Fariba Khamseh")%>%
  ...
  add_row(deck="In the Walls",commander="Karumonix",power="5",played=0,priority="1",W=F,U=F,B=T,R=F,G=F,artist="Flavio Girón")%>%
  ...
  add_row(deck="Minions of Bladehold",commander="Ria Ivor",power="5",played=0,priority="1",W=T,U=F,B=T,R=F,G=F,artist="Andreas Zafiratos")%>%
  ...
  add_row(deck="Necropolis",commander="Ertai",power="5",played=0,priority="1",W=T,U=T,B=T,R=F,G=F,artist="Sidharth Chaturvedi")%>%
  ...
  add_row(deck="Resist",commander="Otharri",power="5",played=0,priority="1",W=T,U=F,B=F,R=T,G=F,artist="Marta Nael")%>%
  ...
  add_row(deck="Sunburst in the Wastes",commander="The Peregrine Dynamo",power="5",played=0,priority="1",W=T,U=F,B=F,R=T,G=F,artist="Zoltan Boros") %>%
  ...
  add_row(deck="Trolls in the kitchen! ",commander="Gyome",power="5",played=0,priority="1",W=F,U=F,B=T,R=F,G=T,artist="Steve Prescott")%>% 
  ...
  add_row(deck="Two Kobolds, One Stone",commander="Toggo & Sakashima",power="5",played=0,priority="1",W=F,U=T,B=F,R=T,G=F,artist="Svetlin Velinov,Jason A. Engle")%>%  
  ...
  add_row(deck="You're Gonna Need Some Secularism",commander="Sarevok with Noble Heritage",power="5",played=0,priority="1",W=T,U=F,B=T,R=F,G=F,artist="Ben Hill,Dallas Williams")%>%
  add_row(deck="Zendikar's Future",commander="Ardenn & Eligeth",power="5",played=0,priority="1",W=T,U=T,B=F,R=F,G=F,artist="Jason Rainville,Yigit Koroglu")%>%# priority: 0 no buying cards for this (proxy free)
