...
decks<-decks%>%#priority 6: Tournament cEDH
  ...
  add_row(deck="Calculator Manipulation",commander="Obeka",power="6",played=6,won=2,draw=1,lost=3,priority="5",W=F,U=T,B=T,R=T,G=F,artist="Jesper Ejsing",plane='Unknown')%>% 
  ...
  add_row(deck="Descend Into Madness",commander="Anhelo",power="5",played=2,won=1,draw=0,lost=1,priority="5",W=F,U=T,B=T,R=T,G=F,artist="Marta Nael",plane='New Capenna') %>%
  ...
  add_row(deck="Graveyard of Nightmares",commander="Beamtown Bullies",power="5",played=2,won=0,draw=0,lost=2,priority="5",W=F,U=F,B=T,R=T,G=T,artist="Tyler Jacobson",plane='New Capenna')%>%
  ...
  add_row(deck="Illusions of Property",commander="Rubinia",power="5",played=1,won=0,draw=0,lost=1,priority="5",W=T,U=T,B=F,R=F,G=T,artist="Cynthia Sheppard",plane='Unknown')%>%
  ...
  add_row(deck="Off To See The Wizard",commander="Inalla",power="5",played=5,won=0,draw=0,lost=5,priority="5",W=F,U=T,B=T,R=T,G=F,artist="Yongjae Choi",plane='Unknown')%>%
  ...
  add_row(deck="Point Mutation",commander="Otrimi",power="5",played=3,won=1,draw=0,lost=2,priority="5",W=T,U=T,B=F,R=F,G=T,artist="Victor Adame Minguez",plane='Ikoria') %>%
  ...
  add_row(deck="Reyhan and the Merfolks",commander="Thrasios & Reyhan",power="7",played=8,won=3,draw=0,lost=5,priority="5",W=F,U=T,B=T,R=F,G=T,artist="Josu Hernaiz,Chris Rallis",plane='Theros,Tarkir') %>%
  add_row(deck="Rolling Blackouts",commander="Yidris",power="5",played=3,priority="5",W=F,U=T,B=T,R=T,G=T,artist="Karl Kopinski",plane='Alara') %>%
  ...
  add_row(deck="The Stack Is Your Wonderland",commander="Parnesse",power="6",played=9,won=0,draw=1,lost=8,priority="5",W=F,U=T,B=T,R=T,G=F,artist="Svetlin Velinov",plane='New Capenna')%>%
   add_row(deck="True Love",commander="Regna & Krav",power="5",played=2,won=0,draw=0,lost=2,priority="5",W=T,U=F,B=T,R=F,G=F,artist="Randy Vargas,Randy Vargas",plane='Kylem,Kylem')%>%  
  ...
  add_row(deck="For Uther!",commander="Ponyback Brigade",power="5",played=0,won=0,draw=0,lost=0,priority="4",W=F,U=F,B=F,R=T,G=T,artist="Mark Zug",plane='Tarkir') %>%
  # priority 3: non-tournament cEDH 
  add_row(deck="Metallic Shark",commander="Shabraz & Brallin",power="3",played=4,won=1,draw=0,lost=0,priority="3",W=F,U=T,B=T,R=T,G=F,artist="Paul Scott Canavanm,Paul Scott Canavan",plane='Ikoria,Ikoria')%>%  
 ...
 #priority 1: unsleeved and unfinished
  ...
  add_row(deck="There Can Only Be One",commander="Elsha",power="5",played=0,won=0,draw=0,lost=0,priority="1",W=T,U=T,B=F,R=T,G=F,artist="G-host Lee",plane='Tarkir')%>% 
