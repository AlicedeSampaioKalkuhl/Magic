...
decks<-decks%>%#priority 7: Tournament cEDH
  ...
  add_row(deck="Doomed by the Obscura",commander="Toluz",power="10",played=3,priority="7",W=T,U=T,B=T,R=F,G=F,artist="Donato Giancola")%>% 
  ...
  add_row(deck="Sultai Mean Girls",commander="Sidisi",power="9",played=2,priority="7",W=F,U=T,B=T,R=F,G=T,artist="Karl Kopinski")%>%
  ...
  add_row(deck="Nephalia Nightmares",commander="Jeleva",power="7",played=10,priority="6",W=F,U=T,B=T,R=T,G=F,artist="Cynthia Sheppard")%>% # priority 5: LGS low power 
  ...
  add_row(deck="Let's All Work Together",commander="Sen Triplets",power="6",played=6,priority="5",W=T,U=T,B=T,R=F,G=F,artist="Greg Staples")%>%  # continue here 
  add_row(deck="Party of Two",commander="Minthara",power="5",played=0,priority="5",W=T,U=F,B=T,R=F,G=F,artist="Evyn Fong")%>%
  ...
  add_row(deck="Curious Beasts",commander="Brallin & Shabraz",power="7",played=16,priority="2",W=T,U=T,B=F,R=T,G=F,artist="Paul Scott Canavan,Paul Scott Canavan")%>% 
  ...
  add_row(deck="Don't Talk To Me",commander="Florian",power="5",played=1,priority="2",W=F,U=F,B=T,R=T,G=F,artist="Justine Cruz")%>% 
  ...
  add_row(deck="Prismari for Life",commander="Galazeth Prismari",power="5",played=0,priority="2",W=F,U=T,B=F,R=T,G=F,artist="Iain McCaig")%>%
  ...
  add_row(deck="Time to Forget",commander="Archelos",power="6",played=5,priority="2",W=F,U=T,B=T,R=F,G=T,artist="Dan Scott")%>%
  ...
  add_row(deck="Astelle's Maze",commander="Nine-Fingers Keene",power="5",played=0,priority="1",W=F,U=T,B=T,R=F,G=T,artist="Nils Hamm")%>%
  ...
  add_row(deck="Find the Bride",commander="Korvold",power="5",played=0,priority="1",W=F,U=F,B=T,R=T,G=T,artist="Wisnu Tan")%>%
  ...
  add_row(deck="Kept in Suspense",commander="Illuna",power="5",played=0,priority="1",W=F,U=T,B=F,R=T,G=T,artist="Chris Rahn")%>%
  ...
  add_row(deck="Roll for Honey",commander="Xira",power="5",played=0,priority="1",W=F,U=F,B=T,R=T,G=T,artist="Mila Pesic") %>%
  add_row(deck="Royal Snowball",commander="Queen Marchesa",power="9",played=0,priority="1",W=T,U=F,B=T,R=T,G=F,artist="Kieran Yanner")%>%
  ...
  add_row(deck="So many Spellseekers",commander="Ivy",power="9",played=0,priority="1",W=F,U=T,B=F,R=F,G=T,artist="Eshpur")%>%
  ...
  add_row(deck="Women in STEM",commander="Sophina & Cecily",power="5",played=0,priority="1",W=T,U=T,B=T,R=T,G=F,artist="Bartek Fedyczak,Anastasia Balakchina")%>%# priority: 0 no buying cards for this (proxy free)
  ...
  add_row(deck="The Dispossesed",commander="Meren",power="5",played=0,priority="0",W=T,U=T,B=T,R=T,G=F,artist="Mark Winters")%>%# priority: NA retired 
add_row(deck="Hot Girl Summer",commander="Jeska & Tymna",power="9",played=12,priority="0",W=T,U=F,B=T,R=T,G=F,artist="Yongjae Choi,Winona Nelson")
