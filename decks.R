...
decks<-decks%>%#priority 7: Tournament cEDH
  ...
  add_row(deck="Amphibian Hugs",commander="Gor Muldark",power="5",played=5,priority="6",W=F,U=T,B=F,R=F,G=T)%>%
  add_row(deck="Gifts to the Table",commander="Parnesse",power="6",played=8,priority="2",W=F,U=T,B=T,R=T,G=F)%>%
  add_row(deck="Graveyard of Nightmares",commander="Beamtown Bullies",power="6",played=0,priority="5",W=F,U=F,B=T,R=T,G=T)%>%
  add_row(deck="Hellrider's Pride",commander="Zevlor",power="5",played=1,priority="5",W=F,U=T,B=T,R=T,G=F)%>%
  add_row(deck="Let Me Borrow This",commander="Yasova",power="5",played=3,priority="6",W=F,U=T,B=T,R=T,G=F)%>%  
  add_row(deck="Let's All Work Together",commander="Sen Triplets",power="6",played=5,priority="5",W=T,U=T,B=T,R=F,G=F)%>%  
  add_row(deck="Over The Hills",commander="Rubinia",power="5",played=0,priority="5",W=T,U=T,B=F,R=F,G=T)%>%
  ...
  add_row(deck="Doomsday Experiment",commander="Jan",power="9",played=0,priority="4",W=T,U=F,B=T,R=T,G=F)%>%
  add_row(deck="Doves & Peace",commander="Lavinia",power="9",played=0,priority="4",W=T,U=T,B=F,R=F,G=F)%>% 
  ...
  add_row(deck="Survival",commander="Ukkima & Cazur",power="9",played=0,priority="4",W=F,U=T,B=T,R=F,G=T)%>% 
  add_row(deck="Zombies & Jellyfish",commander="Sidisi",power="9",played=0,priority="4",W=F,U=T,B=T,R=F,G=T)%>% 
  # priority 3: Casual and Proxied 
  ...
  add_row(deck="You Should Be Nicer",commander="Atla",power="6",played=6,priority="2",W=T,U=F,B=F,R=T,G=T)%>% # priority 2: pauper 
  add_row(deck="Challenger",commander="Mr Orfeo",power="4",played=1,priority="2",W=F,U=F,B=T,R=T,G=T)%>%
  add_row(deck="Poor Little Goblins",commander="Gut",power="4",played=0,priority="2",W=F,U=F,B=T,R=T,G=F)%>%# priority 1: unsleeved 
  ...
  add_row(deck="Cursed Gold",commander="Linde",power="4",played=0,priority="1",W=F,U=T,B=F,R=T,G=F)%>%  
  ...
  add_row(deck="Jeskai Lore",commander="Shu Yun",power="5",played=0,priority="1",W=T,U=T,B=F,R=T,G=F)%>%
  ...
  add_row(deck="Party of Two",commander="Minthara",power="5",played=0,priority="1",W=T,U=F,B=T,R=F,G=F)%>%
  ...
  add_row(deck="Population of Llanowar",commander="Allenal",power="5",played=0,priority="1",W=T,U=T,B=F,R=F,G=F)%>%
  ...
  add_row(deck="Spellstealing Mutants",commander="Ivy",power="5",played=0,priority="1",W=F,U=T,B=F,R=F,G=T) %>% 
