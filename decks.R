...
decks<-decks%>%#priority 7: Tournament cEDH
  ...
  add_row(deck="Depths of Darkness",commander="Thrasios & Reyhan",power="7",played=8,priority="6",W=F,U=T,B=T,R=F,G=T,artist="Josu Hernaiz,Chris Rallis") %>%
  ...
  add_row(deck="Astelle's Maze",commander="Nine-Fingers Keene",power="5",played=1,priority="5",W=F,U=T,B=T,R=F,G=T,artist="Nils Hamm")%>%
